...
class JointBERT(BertPreTrainedModel):
    ...
    def forward(self, input_ids = None, attention_mask = None, token_type_ids = None, intent_label_ids = None, slot_labels_ids = None, **kwargs):
        outputs = self.bert(input_ids, attention_mask=attention_mask,
                            token_type_ids=token_type_ids, **kwargs)  # sequence_output, pooled_output, (hidden_states), (attentions)
